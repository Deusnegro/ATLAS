...
""").split()
        ...
        try:
            input(Fore.YELLOW+"\n   /"+Fore.LIGHTRED_EX+"M"+Fore.WHITE+"\   "+Fore.WHITE+"Back To Menu (Press Enter...) ")
        except:
            print("")
            sys.exit()
    except:
